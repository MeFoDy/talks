...
scope:"number",
begin:e.NUMBER_RE+"(%|em|ex|ch|rem|vw|vh|vmin|vmax|cqw|cqh|cm|mm|in|pt|pc|px|deg|grad|rad|turn|s|ms|Hz|kHz|dpi|dpcm|dppx)?",
...
;hljs.registerLanguage("less",e)})();/*! `makefile` grammar compiled for Highlight.js 11.8.0 */
